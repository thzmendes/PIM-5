...
namespace PIM
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            while (opcao != 6)
            {
                Console.WriteLine("Menu - 1-Novo Aluguel 2- Devolver Equipamento 3-Professores com atraso de aluguel 4- Cadastrar Professor 5- Verificar Estoque 6- Sair");
                    ...
                    case 1:
                        ...
                        if (professor != null)
                        {
                            ...
                            for (int i = 0; i < qntd; i++)
                                sucesso = Alugue/lManager.Alugar(professor);
